...
namespace test
{
    TestRotate::TestRotate() :
        ...
        m_texture("res/textures/flappy-top-pipe.png"),
        m_renderer(),
    ...
    void TestRotate::OnUpdate(float deltaTime)
    {
    }

    void TestRotate::OnRender()
    {
        m_renderer.clear();
...

        {
            ...
            //glm::mat4 model = glm::translate(glm::mat4(1.0f), glm::vec3(960.0f, 510.0f, 1.0f));
    ...
    void TestRotate::OnImGuiRender()
    {
        ...
        //ImGui::SliderFloat3("Rotate", &m_rotate.x, 0.0f, 360.0f);
    }
};
